        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
              ...
              <ul className="space-y-1.5">
                {[
                  ...
                  <li
                    ...
                    style={{ color: "#4b5563" }}
                  >
                    <span className="font-bold" style={{ color: "#945c67" }}>
                      •
                    </span>
                    {item}
                  </li>
          ...
          <div>
            <div
              ...
              style={{ borderColor: "rgba(148,92,103,0.18)" }}
            >
