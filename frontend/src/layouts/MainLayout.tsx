          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <a
                  href="https://www.instagram.com/mamvibe"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label={t("footer.social_instagram")}
                  className="w-9 h-9 rounded-full flex items-center justify-center bg-gray-100 dark:bg-white/10 text-gray-500 dark:text-gray-400 hover:bg-pink-100 dark:hover:bg-pink-500/20 hover:text-pink-500 transition-all"
                >
                ...
                <a
                  href="https://www.tiktok.com/@mamvibe"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label={t("footer.social_tiktok")}
                  className="w-9 h-9 rounded-full flex items-center justify-center bg-gray-100 dark:bg-white/10 text-gray-500 dark:text-gray-400 hover:bg-black/10 dark:hover:bg-white/20 hover:text-black dark:hover:text-white transition-all"
                >
                  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg">
                ...
                <a
                  href="https://www.linkedin.com/company/mamvibe"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="rounded-2xl bg-gray-100 dark:bg-[#2d2a42] p-5 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div
                  ...
                  className="relative flex items-center gap-3 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-2.5 opacity-50 cursor-not-allowed select-none"
                >
                  <svg viewBox="0 0 24 24" className="h-6 w-6 fill-gray-500 dark:fill-white/50 flex-shrink-0" xmlns="http://www.w3.org/2000/svg">
                ...
                <div
                  ...
                  className="relative flex items-center gap-3 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-2.5 opacity-50 cursor-not-allowed select-none"
                >
                  <svg viewBox="0 0 24 24" className="h-6 w-6 flex-shrink-0 opacity-60" xmlns="http://www.w3.org/2000/svg">
