      ...
      <footer className="bg-white dark:bg-[#1a1825] border-t border-gray-200 dark:border-gray-700/60 py-10 mt-auto transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            {/* Download the app */}
            <div className="rounded-2xl bg-[#0d1117] p-5 flex flex-col gap-4">
              <h3 className="text-base font-bold text-cyan-400">{t("footer.download")}</h3>
              <div className="flex flex-col gap-3">
                {/* App Store badge */}
                <a
                  href="#"
                  aria-label={t("footer.app_store")}
                  className="flex items-center gap-3 border border-white/20 rounded-xl px-4 py-2.5 hover:bg-white/10 transition-colors"
                >
                  ...
                  <div className="leading-tight">
                    <div className="text-white/60 text-[10px]">Download on the</div>
                ...
                >
                  ...
                  <div className="leading-tight">
                    <div className="text-white/60 text-[10px]">GET IT ON</div>
