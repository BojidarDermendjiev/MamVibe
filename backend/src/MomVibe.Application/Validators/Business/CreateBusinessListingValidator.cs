...
/// <summary>
/// FluentValidation rules for <see cref="CreateBusinessListingRequest"/>.
/// Lat/Lng are optional but must form a valid pair when supplied.
/// </summary>
public class CreateBusinessListingValidator : AbstractValidator<CreateBusinessListingRequest>
{
    public CreateBusinessListingValidator()
    {
